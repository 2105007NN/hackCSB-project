...
const Chat = ({currentUser, targetUser, list, setList, roomId, setRoomId, socket}) => {
    ...
    //             <ScrollToBottom className="h-[500px] overflow-y-auto" behavior="smooth">
    //             {list.map((m, index) => (
    //                 <div key={index} className="flex m-3 items-start">
    //                 <img className="w-8 h-8 rounded-full" src="/docs/images/people/profile-picture-3.jpg" alt="User"/>
    //                 <div className="flex flex-col gap-1 w-full max-w-[320px]">
    //                     <div className="flex items-center space-x-2">
    //                     <span className="text-sm font-semibold text-gray-900 dark:text-white">{m.author}</span>
    //                     <span className="text-sm font-normal text-gray-500 dark:text-gray-400">{m.time}</span>
    //                     </div>
    //                     <div className="flex flex-col leading-1.5 p-4 border-gray-200 bg-gray-100 rounded-e-xl rounded-es-xl dark:bg-gray-700">
    //                     <p className="text-sm font-normal text-gray-900 dark:text-white">{m.content}</p>
    //                     </div>
